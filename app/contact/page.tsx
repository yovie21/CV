            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-white font-mono text-sm group-hover:text-cyan-400 transition-colors">yovie6513@gmail.com</div>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-xs font-mono text-slate-500">whatsapp</div>
                  <div className="text-white font-mono text-sm group-hover:text-cyan-400 transition-colors">082297920784</div>
                </div>
              </a>
